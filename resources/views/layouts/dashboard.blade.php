    ...
    <body>
            ...
            <div class="topbar-main">
                <div class="container-fluid">
                    ...
                    <div class="logo">
                        ...
                        <!-- Image Logo -->
                        <a href="index.html" class="logo">
                            <img src="{{ asset('images/logo_dark.png') }}" alt="" height="24" class="logo-lg">
        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <!-- Prepare layout to expect page title -->
                ...
                <!-- we tell the dashboard layout to expect some views here -->
                @yield('content')
